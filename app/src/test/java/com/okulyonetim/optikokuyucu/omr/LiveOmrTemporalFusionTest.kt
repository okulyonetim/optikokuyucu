...
class LiveOmrTemporalFusionTest {
    ...
    fun `one weak camera frame does not erase a persistent light answer`() {
        ...
        val fused = requireNotNull(
            fusion.offer(bubbles(0.16, 0.03), MarkGridReadResult.Empty)
        )
    ...
    fun `persistent double answer survives one asymmetric frame`() {
        ...
        val fused = requireNotNull(
            fusion.offer(bubbles(a = 0.25, c = 0.21), MarkGridReadResult.Empty)
        )
    ...
    fun `template structure change clears the temporal window`() {
        ...
        val result = fusion.offer(
            bubbles(0.17, 0.03, questionId = "2"),
    ...
    private fun bubbles(
        ...
        c: Double,
        questionId: String = "1"
    ): BubbleReadResult = BubbleReadResult(
        listOf(
            QuestionRead(
    ...
    private fun grid(
        digit4: Double,
        digit7: Double
    ): MarkGridReadResult = MarkGridReadResult(
        listOf(
            MarkGridRead(
                gridId = "number-1",
                columns = listOf(
