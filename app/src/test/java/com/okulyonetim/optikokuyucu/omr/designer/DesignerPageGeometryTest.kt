...
class DesignerPageGeometryTest {
    ...
    @Test
    fun `editor canvas stays full width for every paper size`() {
        listOf(
            ...
            DesignerPageOrientation.entries.forEach { orientation ->
                assertEquals(
                    1.0,
                    DesignerPageGeometry.editorDisplayWidthScale(paper, orientation),
                    0.000001
                )
            }
        }
